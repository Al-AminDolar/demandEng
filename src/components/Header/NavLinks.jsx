      ...
      {links.map((link) => (
        <div key={link.name}>
          <div className="px-3 text-left md:cursor-pointer group">
            <h1
              className="py-2 md:py-7 flex justify-between items-center md:pr-0 pr-5 group"
              onClick={() => {
            ...
            >
              ...
              <span className="text-xl md:mt-1 md:ml-2  md:block hidden group-hover:rotate-180 duration-200 group-hover:-mt-2">
            ...
            {link.submenu && (
              <div>
                <div className="absolute top-20 hidden group-hover:md:block hover:md:block ">
                  ...
                  <div className="bg-indigo-200 p-5 grid grid-cols-3 gap-10 border ">
